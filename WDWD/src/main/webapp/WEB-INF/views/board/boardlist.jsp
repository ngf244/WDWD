		...
		<div id="main" style="background: white">
			...
			<c:forEach var="b" items="${ list }">
				...
				<div class="freeBoardList">
					...
					<div class="input box1">${ b.boCategory }</div>
					<!-- 카테고리 -->
					<div class="input box2">${ b.boTitle }</div>
					<!-- 제목 -->
					<div class="input box3">
						<span class="smallOption"> ${ b.boWriter } </span>
					</div>
					<!-- 작성자 -->
					<div class="input box4">${ b.boReNum }</div>
					<!-- 파일 -->
					<div class="input box5">${ b.boView  }</div>
					<!-- 조회수 -->
					<div class="input box6">${ b.boGood }</div>
					<!-- 추천수 -->
				</div>
			</c:forEach>
